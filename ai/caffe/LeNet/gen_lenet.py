...
def lenet(train_lmdb, test_lmdb, train_batch_size, test_batch_size, output_path):
    ...
    n.conv1 = L.Convolution(n.data, name='conv1', kernel_size=5, num_output=20, weight_filler=dict(
...
lenet('/home/zxh/caffe/examples/mnist/mnist_train_lmdb', '/home/zxh/caffe/examples/mnist/mnist_test_lmdb',
      64, 100, '/home/zxh/caffe/test/mnist')
