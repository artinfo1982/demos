...
# copy from https://github.com/BUG1989/caffe-int8-convert-tools/blob/master/caffe-int8-convert-tool.py
# Usage: python caffe-int8-convert-tool-dev.py --proto=deploy.prototxt --model=vgg16.caffemodel --mean 103.94 116.78 123.68 --norm=0.017 --images=test/images/ output=test.table --gpu=1
