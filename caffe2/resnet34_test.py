...
# python resnet34_test.py --train_data=/home/zxh/tutorials/tutorial_data/mnist/mnist-train-nchw-leveldb --test_data=/home/zxh/tutorials/tutorial_data/mnist/mnist-test-nchw-leveldb --use_cpu=True --db_type=leveldb --batch_size=2 --epoch_size=20 --num_epochs=10
...
logging.basicConfig()
log = logging.getLogger("resnet34_trainer")
...
def SaveModel(workspace, train_model):
    ...
    with open('/home/zxh/tmp/resnet34_init_net.pb', 'wb') as f:
        f.write(init_net.SerializeToString())
    with open('/home/zxh/tmp/resnet34_predict_net.pb', 'wb') as f:
...
def Train(args):
    ...
    train_model = model_helper.ModelHelper(
        name="resnet34", arg_scope=train_arg_scope
    )
    ...
    def create_resnet34_model_ops(model, loss_scale):
    ...
    data_parallel_model.Parallelize(
        ...
        forward_pass_builder_fun=create_resnet34_model_ops,
    ...
    if (args.test_data is not None):
        ...
        test_model = model_helper.ModelHelper(
            name="resnet34_test", arg_scope=test_arg_scope, init_params=False
        )
    ...
    expname = "resnet34_gpu%d_b%d_L%d_lr%.2f_v2" % (
        args.num_gpus,
        total_batch_size,
        args.num_labels,
        args.base_learning_rate,
...
def main():
    parser = argparse.ArgumentParser(
        description="Caffe2: resnet34 training"
    )
    ...
    parser.add_argument("--save_model_name", type=str, default="resnet34_model",
