...
# python resnet101_test.py --train_data=/home/zxh/tutorials/tutorial_data/mnist/mnist-train-nchw-leveldb --test_data=/home/zxh/tutorials/tutorial_data/mnist/mnist-test-nchw-leveldb --use_cpu=True --db_type=leveldb --batch_size=2 --epoch_size=20 --num_epochs=10
...
logging.basicConfig()
log = logging.getLogger("resnet101_trainer")
...
def SaveModel(workspace, train_model):
    ...
    with open('/home/zxh/tmp/resnet101_init_net.pb', 'wb') as f:
        f.write(init_net.SerializeToString())
    with open('/home/zxh/tmp/resnet101_predict_net.pb', 'wb') as f:
...
def Train(args):
    ...
    train_model = model_helper.ModelHelper(
        name="resnet101", arg_scope=train_arg_scope
    )
    ...
    if (args.test_data is not None):
        ...
        test_model = model_helper.ModelHelper(
            name="resnet101_test", arg_scope=test_arg_scope, init_params=False
        )
...
def main():
    parser = argparse.ArgumentParser(
        description="Caffe2: resnet101 training"
    )
    ...
    parser.add_argument("--save_model_name", type=str, default="resnet101_model",
